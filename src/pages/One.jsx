...
export default function One() {
  ...
  const handleNext = () => {
    console.log("ค่าที่กรอก:", ans1);
    localStorage.setItem("ans1", ans1); // เก็บใน localStorage ถ้าจะใช้หน้าถัดไป
    navigate("/two"); // ไปอีกหน้า
  };
  ...
  return (
    <div className="prologue-container">
      ...
      <div className="text-wrapper">
        ...
        >
          ภาพจำสีท้องฟ้าที่คุณชอบ เป็นสีแบบไหน?
        </motion.p>
